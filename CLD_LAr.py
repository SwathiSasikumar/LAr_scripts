...
detectors_to_use=["/home/ksasikum/Key4Hep/LAr_scripts/k4geo/FCCee/CLD/compact/CLD_o4_v05/CLD_o4_v05.xml",
...
#                          "DD4hepXMLFile": ["/home/ksasikum/Key4Hep/LAr_scripts/pandoraPFA/CLD_LAr/FCCee_o1_v05.xml"],
...
MyRecoMCTruthLinker.Parameters = {
                                  ...
                                  "SimCaloHitCollections": ["ECalBarrelEta", "ECalEndcapCollection", "HCalBarrelCollection", "HCalEndcapCollection", "HCalRingCollection", "YokeBarrelCollection", "YokeEndcapCollection", "LumiCalCollection"],
...
LumiCalReco.Parameters = {
                          ...
                          "LumiCal_RecoParticles": ["LumiCalCollectionContributions"],
                          "MaxRecordNumber": ["10"],
...
MyDDSimpleMuonDigiE = MarlinProcessorWrapper("MyDDSimpleMuonDigiE")
MyDDSimpleMuonDigiE.OutputLevel = WARNING
MyDDSimpleMuonDigiE.ProcessorType = "DDSimpleMuonDigi"
MyDDSimpleMuonDigiE.Parameters = {
                                 "CalibrMUON": ["170.1"],
                                 "MUONCollections": ["ECalBarrelEta"],
                                 "MUONOutputCollection": ["ECalHitCollection"],
                                 "MaxHitEnergyMUON": ["2.0"],
                                 "MuonThreshold": ["1e-06"],
                                 "RelationOutputCollection": ["RelationECalHit"]
                                 }
...
cellPositionEcalBarrelTool = CellPositionsECalBarrelTool("CellPositionsECalBarrel", readoutName = "ECalBarrelPhiEta", OutputLevel = INFO)

from Configurables import CreateCaloCellPositionsFCCee
createEcalBarrelPositionedCells = CreateCaloCellPositionsFCCee("ECalBarrelPositionedCells", OutputLevel = WARNING)
...
createEcalBarrelPositionedCells.OutputLevel=DEBUG
createEcalBarrelPositionedCells.positionedHits.Path = "ECalBarrelPositionedCells"


edmConvTool2 = EDM4hep2LcioTool("EDM4hep2lcioLar")
edmConvTool2.OutputLevel = DEBUG
edmConvTool2.convertAll = False
edmConvTool2.collNameMapping = {
    'ECalBarrelPositionedCells':   'ECalBarrelPositionedCells',   
}
...
createemptycells.cells.Path = "emptyECalCaloCells"

from Configurables import CreateEmptyCaloCellsCollection
createemptycells2 = CreateEmptyCaloCellsCollection("CreateEmptyCaloCells2")
createemptycells2.cells.Path = "emptyECalCaloCellsEndCap"
...
MyDDCaloDigi["10"].Parameters = {
                                ...
                                "ECALCollections": ["emptyECalCaloCells", "ECalEndcapCollection"],
...
MyDDMarlinPandora["10"].EDM4hep2LcioTool = edmConvTool2
MyDDMarlinPandora["10"].OutputLevel = INFO
...
MyDDMarlinPandora["10"].Parameters = {
                                     ...
                                     "ECalCaloHitCollections": ["ECalBarrelPositionedCells", "ECALEndcap", "ECALOther"],
                                     ...
                                     #"ECalToEMGeVCalibration": ["1.12776966108"],
                                     #"ECalToEMGeVCalibration": ["1.01776966108"],
                                     "ECalToEMGeVCalibration": ["1.18213718"],
...
out = PodioOutput("PodioOutput", filename = "Code_testing.root")
...
algList.append(createEcalBarrelCellsStep1)
algList.append(resegmentEcalBarrel)
algList.append(createEcalBarrelCells)
algList.append(createEcalBarrelPositionedCells)
#algList.append(MyAIDAProcessorLar)
algList.append(MyDDSimpleMuonDigi)
algList.append(MyDDSimpleMuonDigiE)
algList.append(createemptycells)
algList.append(createemptycells2)
...
ApplicationMgr( TopAlg = algList,
                EvtSel = 'NONE',
                EvtMax   = 1000,
                ExtSvc = [evtsvc, geoservice, cellIDSvc],
                OutputLevel=WARNING
              )
